...
class CarRentalSearch extends StatefulWidget {
  const CarRentalSearch({super.key});

  @override
  State<CarRentalSearch> createState() => _CarRentalSearchState();
}

class _CarRentalSearchState extends State<CarRentalSearch> {
  final String apiKey = '55c7cc897bmshdd2c886dd5930b9p1c1592jsn46b784a37fdf';
  final String apiHost = 'booking-com18.p.rapidapi.com';
  List<dynamic> cars = [];
  ...
  void fetchCars() async {
    ...
    const url =
        'https://booking-com18.p.rapidapi.com/car/auto-complete?query=islamabad';
